...
golem::add_module(name = "accessories", with_test = TRUE)
golem::add_module(name = "clothing", with_test = TRUE)
golem::add_module(name = "bikes", with_test = TRUE)
...
usethis::use_data_raw(name = "prod", open = FALSE)
...
## Vignette ----
usethis::use_vignette("productDashboard")
